...
try {
  ...
  writeFileSync(join(temp, 'tsconfig.json'), JSON.stringify({
    ...
    files: ['consumer.mts', 'intent-consumer.mts', 'registration-consumer.mts']
  }));
  ...
  copyFileSync(join(root, 'packages/saga-runtime/test/registration-consumer.mts'), join(temp, 'registration-consumer.mts'));
