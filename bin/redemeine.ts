...
async function main() {
  ...
  switch (command) {
    case 'init':
      ...
      console.log(colors.cyan(`2. Run 'pnpm exec redemeine add-entity' to add nested collections.`));
      console.log(colors.cyan(`3. Use 'pnpm exec tsc' to verify your new aggregate.`));
      break;
    case 'add-entity':
